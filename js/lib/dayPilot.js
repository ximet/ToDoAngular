...
(function() {
    ...
    DayPilot.Locale.register(new DayPilot.Locale('cs-cz', {'dayNames': ['ned?le', 'pond?lí', 'úterý', 'st?eda', '?tvrtek', 'pátek', 'sobota'],'dayNamesShort': ['ne', 'po', 'út', 'st', '?t', 'pá', 'so'],'monthNames': ['leden', 'únor', 'b?ezen', 'duben', 'kv?ten', '?erven', '?ervenec', 'srpen', 'zá?í', '?íjen', 'listopad', 'prosinec', ''],'monthNamesShort': ['I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 'X', 'XI', 'XII', ''],'timePattern': 'H:mm','datePattern': 'd. M. yyyy','dateTimePattern': 'd. M. yyyy H:mm','timeFormat': 'Clock24Hours','weekStarts': 1}));
